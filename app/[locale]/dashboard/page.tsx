            ...
            <ul className=" grid grid-cols-2 lmobile:grid-cols-3 md:grid-cols-4 3xl:grid-cols-5 justify-between gap-2 ">
                {
                    numberStats.map((obj, idx) => {
                        ...
                        return(
                            <Link href={obj.link} >
                                <li key={idx} className=" relative flex flex-col xl:flex-row justify-between gap-2 w-full py-2 px-2 bg-white mobile:px-5 rounded-md shadow-custom_shad5 dark:shadow-custom_shad6 z-[1]  " >
